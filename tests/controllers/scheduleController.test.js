...
// Assuming your Express app setup is in app.js

describe('Schedule Controller', () => {
    describe('GET /api/schedules', () => {
        it('should return an array of schedules', async () => {
            // Define a mock schedule array
            const mockSchedules = [{ id: 1,dayOfWeek: "Monday", startTime:"08:00",endTime:"19:00", courseName:"strength of material" }, { id:2,dayOfWeek: "Monday", startTime:"08:00",endTime:"19:00", courseName:"weak of material" }];

            // Stub the Schedule model's find method to return the mock schedule array
            ; // Assuming Schedule model is in models directory
            ...
            expect(response.body[0]).to.deep.equal({ id: 1,courseName:"strength of material" });
            expect(response.body[1]).to.deep.equal({ id: 2, courseName:"weak of material" });
    ...
    describe('POST /api/schedules', () => {
        it('should create a new schedule', async () => {
           ...
           const mockSchedule= { id: 1,dayOfWeek: "Monday", startTime:"08:00",endTime:"19:00", courseName:"strength of material" }
            ...
            const response = await supertest(app)
                .post('/api/schedules')
                .send({ courseName:"strength of material" });
