...
//     const notifications = [
//       { user: userId, message: "Notification 1" },
//       { user: userId, message: "Notification 2" },
//     ];
...
//         expect.objectContaining({ message: "Notification 1" }),
//         expect.objectContaining({ message: "Notification 2" }),
//       ])
//     );
//   });
...
//     const req = { params: { id: notification._id.toString() } };
//     const res = {
//       json: vi.fn(),
//       status: vi.fn(() => res),
//     };
